...
#### Стэк: OpenJDK 18.
#### Полезные ссылки
Видео с подробным объяснением работы программы и его структуры можно посмотреть на ютюб _[тут](https://youtu.be/HOmlhfF05-Y)_.
Ведо с демонстрацией работы программы можно посмотреть на ютюб _[тут]()_.
...
Далее представлено краткое описание структуры и возможности программы.
